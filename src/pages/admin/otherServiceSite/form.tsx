...
import { OtherServiceSiteSchema } from "./schema";
...
interface IOtherServiceSiteProps {
  formType: FormType;
  initialValues: IOtherServiceSiteModel;
  onSubmit: (
    values: IOtherServiceSiteModel,
    helpers: FormikHelpers<FormikValues>
  ) => void;
}

const OtherServiceSite = ({ initialValues, onSubmit }: IOtherServiceSiteProps) => {
      ...
      {({
        ...
        <div className="w-full flex gap-x-6 justify-end mb-6">
          <button
            ...
            onClick={() => navigate("/admin/OtherServiceSites")}
...
export default OtherServiceSite;
