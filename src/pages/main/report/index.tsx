...
import { homeBreadCrumb, planeTicketBreadCrumb } from '../../../routes/breadcrumbs';
...
export default function Index() {
  ...
  return (
    <Container maxWidth='xl'>
        <PageTitle title='Hesabat'  breadcrumbs={[homeBreadCrumb, planeTicketBreadCrumb]}/>
      <Table exportLink='v1/PlaneTicket/Export/Export'  columns={columns} api={'/PlaneTicket/GetAll'} buttonText='Hesabat' 
