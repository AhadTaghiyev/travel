      ...
      <div className="w-full flex-col lg:flex-row bg-white mt-12 px-4 lg:px-16 xl:px-24 flex gap-6 pt-8 pb-16">
        ...
        <div className="flex-grow">
          ...
          <form
            ...
            className="grid grid-cols-1 xl:grid-cols-2 gap-x-6 gap-y-4"
          >
            <input
              type="text"
            ...
            <button
              type="submit"
              className="xl:col-span-2 px-6 py-3 bg-[#1876D1] rounded text-xs text-[#f8f9fb] hover:bg-[#4bb7f6] transition"
            >
              Send
            </button>
          </form>
