...
export const columns: GridColDef[] = [
    ...
    { field: 'employeeName', headerName: 'İşçi', flex: 1, headerClassName: 'header-item'},
    { field: 'paidsalary', headerName: 'Ödənilən', flex: 1, headerClassName: 'header-item'},
    { field: 'bonus', headerName: 'Bonus', flex: 1, headerClassName: 'header-item'},
    { field: 'extraSalary', headerName: 'Əlavə', flex: 1, headerClassName: 'header-item'},
