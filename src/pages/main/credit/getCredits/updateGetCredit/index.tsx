...
export default function CreatePopup() {
  ...
  useEffect(() => {
    (async () => {
      setIsLoading(true);
      try {
        const res = await apiService.get(`GetCredit/GetById/${id}`);
              ...
              <Grid container spacing={2} style={{ marginBottom: "70px" }}>
                <Grid item md={3}>
                  ...
                  <>
                    ...
                    >
                      {state.payments?.map((p: any, i: number) => (
                    ...
                    {props.errors && props.errors.paymentId && (
                      <>
                    ...
                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                      <DemoContainer components={["DateTimePicker"]}>
                        <DatePicker
                          ...
                          sx={{ mb: 1 }}
                          label=""
                          defaultValue={dayjs(props.values.date)}
                          onChange={(newValue) => {
                            const event = {
                              target: {
                                name: `date`,
                ...
                <Grid item md={3}>
                  ...
                  <>
                    ...
                    <TextField
                      ...
                      error={!!props.errors && !!props.errors.source}
                      helperText={!!props.errors && props.errors.source}
                    />
                  </>
                  {/* Note */}
                  <>
