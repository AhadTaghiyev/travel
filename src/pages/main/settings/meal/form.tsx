...
interface IMealProps {
  formType: FormType;
  initialValues: IMealModel;
  onSubmit: (values: IMealModel, helpers: FormikHelpers<FormikValues>) => void;
}

const Meal = ({ initialValues, onSubmit }: IMealProps) => {
