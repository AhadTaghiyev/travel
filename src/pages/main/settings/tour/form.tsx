...
interface ITourProps {
  formType: FormType;
  initialValues: ITourModel;
  onSubmit: (values: ITourModel, helpers: FormikHelpers<FormikValues>) => void;
}

const Tour = ({ initialValues, onSubmit }: ITourProps) => {
