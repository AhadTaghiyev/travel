...
interface IFeeProps {
  formType: FormType;
  initialValues: IFeeModel;
  onSubmit: (values: IFeeModel, helpers: FormikHelpers<FormikValues>) => void;
}

const Fee = ({ initialValues, onSubmit }: IFeeProps) => {
