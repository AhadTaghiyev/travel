...
const columns = [
  ...
  { label: "Customer", name: "customer" }, // Hola
  { label: "Passanger", name: "passanger" },
  { label: "Ticket Number", name: "ticketNo" }, // Hola
  { label: "Phone", name: "phone" }, // hola
  { label: "Sector", name: "sector" }, // Hola
  { label: "Travel Dates", name: "travelDates", className: "min-w-28" }, // Hola
];
