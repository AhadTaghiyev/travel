...
import { ExpenditureReportSchema } from "./schema";
...
interface IExpenditureReportFormProps {
  formType: FormType;
...
const ExpenditureReportForm = ({
  initialValues,
  onSubmit,
  formType,
}: IExpenditureReportFormProps) => {
  ...
  return (
    <Formik
      ...
      validationSchema={ExpenditureReportSchema}
    >
      {({
        values,
        errors,
