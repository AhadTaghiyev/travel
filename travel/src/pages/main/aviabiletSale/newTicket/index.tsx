...
const invoiceDirection: IInvoiceDirections = {
  flightDate: Date(),
  direction: '',
};

const planeTicket: IPlaneTicketModel = {
  ticketNo: '',
  passengerName: '',
  segmentCount: 0,
  purchasePrice: 0,
...
const initialValue: IInvoiceModel = {
  date: Date(),
  deadLine: Date(),
  customerId: 0,
                      ...
                      >
                        ...
                        <Grid item md={2}>
                          <CustomTextField
                            label={t('explanation')}
                            value={
                              props.values.planeTickets[index].explanation
                            }
                            change={props.handleChange}
                            type="text"
                          ...
                          {props.values.isCustomerPaid && (
                            <>
                              ...
                              <CustomTextField
                                  label={'Qalıq məbləğ'}
                                  value={
                                    props.values.planeTickets[index].commonPrice! -
                                    props.values.paidAmount!
                                  }
                                  change={props.handleChange}
                                  type="number"
