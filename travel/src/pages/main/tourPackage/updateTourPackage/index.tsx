...
import { TourPackageBreadCrumb,  homeBreadCrumb , updateTourPackageBreadCrumb } from '../../../../routes/breadcrumbs';
...
export default function Index() {
  ...
  //=================
   // handle Modals
   //=================
   const {open, setOpen, modalOption, setModalOption, modalOptions} = useDynamicModal(getCustomers, getDinings, getPersonals, getTours)
  ...
  return (
    <>
      ...
      <PageTitle title='Tur Paket' breadcrumbs={[homeBreadCrumb, TourPackageBreadCrumb,updateTourPackageBreadCrumb]}/>
  ...
  <InputLabel
                        ...
                        <InputLabel
                          ...
                          {
                             props.errors&& props.touched && props.touched.departureDateTime && (
                              <>
                              <FormHelperText sx={{color: 'red'}}>{props.errors.departureDateTime}</FormHelperText>
                            </>
                            )
                          }
                         ...
                         {/* Dönüş tarixi */}
                          ...
                          {
                             props.errors&& props.touched && props.touched.arrivalDateTime && (
                              <>
                              <FormHelperText sx={{color: 'red'}}>{props.errors.arrivalDateTime}</FormHelperText>
                            </>
                            )
                          }
                              {/* Tour  */}
                        ...
                        <Grid item md={2}>
                          ...
                          <Autocomplete
                            disablePortal
                            value={state.dinings.find(dining => dining.id === props.values.diningId) || null}
                            onChange={(event, newValue) => {
                              const newId = newValue ? newValue.id : null;
                              props.handleChange({
                                target: {
